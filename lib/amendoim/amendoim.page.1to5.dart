...
import 'questoes.amendoim.1to5.dart'; // Importe a classe Quiz

class AmendoimPage1to5 extends StatefulWidget {
  final QuizAmendoim1to5 quiz; // Adicione um parâmetro para a classe Quiz

  AmendoimPage1to5(this.quiz);

  @override
  _AmendoimPage1to5State createState() => _AmendoimPage1to5State();
}

class _AmendoimPage1to5State extends State<AmendoimPage1to5>
  ...
  void _nextQuestion() {
    setState(() {
      _mostrarBotao = false;
      _questionIndex = (_questionIndex + 1) % widget.quiz.questionsAmendoim1to5.length;
  ...
  void _previousQuestion() {
    setState(() {
      _mostrarBotao = false;
      _questionIndex =
          (_questionIndex - 1 + widget.quiz.questionsAmendoim1to5.length) %
              widget.quiz.questionsAmendoim1to5.length;
      _scrollController.animateTo(
        0.0,
        duration: const Duration(milliseconds: 500),
        curve: Curves.easeInOut,
  ...
  void _answerQuestion(String selectedOption) {
    String correctAnswer =
        widget.quiz.questionsAmendoim1to5[_questionIndex]['correctAnswer'];
  ...
  void _showAnswerDetail() {
    String questionTitle = questionsAmendoim1to5[_questionIndex]['question'];
    List<String> questionSuposition = questionsAmendoim1to5[_questionIndex]['supositions'];
    List<String> answerCorrect = questionsAmendoim1to5[_questionIndex]['options'];
    String commentId = questionsAmendoim1to5[_questionIndex]['commentId'];
  ...
  Column _showImageQuestion() {
    String? images = widget.quiz.questionsAmendoim1to5[_questionIndex]['images'];
  ...
  Widget build(BuildContext context) {
    List<String> options =
        List.from(widget.quiz.questionsAmendoim1to5[_questionIndex]['options']);
    options.shuffle();

    List<String> supositions =
        List.from(widget.quiz.questionsAmendoim1to5[_questionIndex]['supositions']);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const SizedBox(height: 20),
                    Text(
                      '${widget.quiz.questionsAmendoim1to5[_questionIndex]['question']}',
                      textAlign: TextAlign.justify,
                      style: const TextStyle(
                          fontSize: 14,
                          height: 1.5,
